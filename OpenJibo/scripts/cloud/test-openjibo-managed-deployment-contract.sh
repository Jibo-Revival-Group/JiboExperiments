...
for marker in "OpenJibo__ReleaseSmoke__Enabled=false" "--remove-env-vars" "OpenJibo__ReleaseSmoke__Secret" "OpenJibo__ReleaseSmoke__SigV4ReplayProbe__SecretAccessKey" "/health" "containerapp secret remove" "release-smoke-authorization" "sigv4-replay-probe-secret-key" "failures="; do
