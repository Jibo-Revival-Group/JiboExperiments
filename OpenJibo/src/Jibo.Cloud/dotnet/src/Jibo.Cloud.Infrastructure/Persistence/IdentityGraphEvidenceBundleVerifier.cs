...
public static class IdentityGraphEvidenceBundleVerifier
{
    ...
    public static IdentityGraphEvidenceBundleVerification Verify(string? envelope)
    {
        ...
        return new IdentityGraphEvidenceBundleVerification
        {
            ...
            AdmissionPolicyVersion = Get(payloadFields, "admission-policy-version"),
            AdmissionRecommendation = Get(payloadFields, "admission-recommendation"),
            AdmissionReasons = SplitCsv(Get(payloadFields, "admission-reasons")),
            SatisfiedEvidence = SplitCsv(Get(payloadFields, "admission-satisfied-evidence")),
            RecommendedActions = SplitCsv(Get(payloadFields, "admission-recommended-actions")),
