...
$command = "cd '$(Escape-BashSingleQuoted $scriptDir)' && ./roundtrip-openjibo-harness.sh --source-root '$(Escape-BashSingleQuoted $sourceRootUnix)' --overlay-root '$(Escape-BashSingleQuoted $overlayRootUnix)' --target-mode '$TargetMode'"
