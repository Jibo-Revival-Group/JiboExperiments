...
$command = "cd '$(Escape-BashSingleQuoted $scriptDir)' && ./demo-openjibo-harness.sh --source-root '$(Escape-BashSingleQuoted $sourceRootUnix)' --overlay-root '$(Escape-BashSingleQuoted $overlayRootUnix)' --target-mode '$TargetMode'"
