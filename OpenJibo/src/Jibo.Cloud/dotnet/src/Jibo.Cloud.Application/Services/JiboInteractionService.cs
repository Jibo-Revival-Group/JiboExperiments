    ...
    ICloudStateStore? cloudStateStore = null)
{
        ...
        out string dayName)
    {
        ...
        if (!TryParseDayOfWeek(dayToken, out var targetDay)) return false;
        ...
        else if (match.Groups["this"].Success && dayOffset == 0) return false;
        ...
        out string leadIn)
    {
        ...
        if (hasNextWeekend || hasThisWeekend)
        {
            ...
            else
            {
                ...
                if (dayOffset == 0 && referenceLocalTime.DayOfWeek == DayOfWeek.Saturday) dayOffset = 1;
