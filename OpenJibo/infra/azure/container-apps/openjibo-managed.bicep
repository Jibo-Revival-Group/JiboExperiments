...
@description('Optional previous base64url HMAC key retained during SigV4 replay-key rotation. This is never generated by the foundation deployment.')
@secure()
param sigV4ReplayHmacKeyPrevious string = ''

@description('Version of the current SigV4 replay-observation HMAC key.')
param sigV4ReplayObservationKeyVersion int = 1

@description('Version of the optional previous SigV4 replay-observation HMAC key. Zero means no previous key is configured.')
...
var sigV4ReplayPreviousSecretEntries = !empty(sigV4ReplayHmacKeyPrevious) ? [
  {
    name: 'sigv4-replay-hmac-key-previous'
    value: sigV4ReplayHmacKeyPrevious
  }
] : []
...
], azureSpeechSecretEntries, searchSecretEntries, searchFallbackSecretEntries, sigV4ReplayObserverSecretEntries, sigV4ReplayPreviousSecretEntries, [
  {
...
var sigV4ReplayPreviousEnvEntries = !empty(sigV4ReplayHmacKeyPrevious) ? [
  {
    name: 'OpenJibo__Security__SigV4ReplayObservation__PreviousHmacKey'
    secretRef: 'sigv4-replay-hmac-key-previous'
  }
] : []
var managedEnvVars = concat([
  ...
  {
    name: 'OpenJibo__Security__SigV4ReplayObservation__KeyVersion'
    value: string(sigV4ReplayObservationKeyVersion)
  }
  {
    name: 'OpenJibo__Security__SigV4ReplayObservation__PreviousKeyVersion'
    value: string(sigV4ReplayObservationPreviousKeyVersion)
  }
  {
...
], azureSpeechEnvEntries, searchEnvEntries, searchFallbackEnvEntries, sigV4ReplayObserverEnvEntries, sigV4ReplayPreviousEnvEntries)
