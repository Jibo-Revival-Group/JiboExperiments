...
public sealed class DialogParsingGuardrailTests
{
    ...
    [InlineData("do you like basketball", "robot_favorite_basketball_team", "play myself")]
    ...
    [InlineData("do you like Toy Story", "robot_favorite_movie", "today")]
    [InlineData("do you like Star Wars", "robot_favorite_movie", "today")]
